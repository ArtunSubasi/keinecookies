  ...
  <div id="MainPage">
    <div class="container">
      ...
      <div class="row header" v-if="cookieType == 'WirklichKeineCookies'">
        ...
        <div class="col-sm-12">
          <img 
            src="@/assets/chaitanya-pillala-zDDdoYqQ64U-unsplash-smaller.jpg" 
            alt="Smiley"
          />
        </div>
      ...
      <div class="row header" v-if="cookieType == 'ChocolateChip'">
        ...
        <div class="col-sm-12">
          <img 
            src="@/assets/john-dancy-j2yLCAi9brQ-unsplash-smaller.jpg" 
      ...
      <div class="row header" v-if="cookieType == 'Macarons'">
        ...
        <div class="col-sm-12">
          <img 
            src="@/assets/holly-stratton-KTP5X6SW_b4-unsplash-smaller.jpg" 
            alt="Macarons"
          />
        </div>
        <div class="mx-auto m-3 photo-credits">
            ...
            <div class="row">
              <div class="col-sm-12 mt-5">
                <a href="https://www.esentri.com">
                  <img 
                    src="@/assets/esentri_weiß-gruen.png" 
                    alt="esentri AG"
                  />
                </a>
              </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                <a href="https://www.i-dont-care-about-cookies.eu/de">
                  <img 
                    src="@/assets/u-j-e-s-h-7ySd00IGyx4-unsplash-smaller.jpg" 
                    alt="delete"
                  />
                </a>
              </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                <a href="https://www.oekoside.de">
                  <img 
                    src="@/assets/dhruva-reddy-7NepJK9k8eM-unsplash-supersmall.jpg" 
                    alt="eokoside.de"
                  />
                </a>
              </div>
